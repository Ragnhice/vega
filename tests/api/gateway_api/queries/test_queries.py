...
class TestHunterApiQueries:
    ...
    def test_get_lane_datas(self):
        ...
        assert lane_datas[0]["id"], "Нет ответа от запроса"
        assert isinstance(lane_datas[0]["isBusy"], bool), "Ошибка тип не равен bool"

    @pytest.mark.test_case("https://jira.steor.tech/browse/VEGA2-364")
    @allure.title("units")
    ...
    def test_get_startup_api_version(self):
        ...
        assert startup_api_version[0]["startupApiVersion"], "Нет ответа от запроса"
    ...
    def test_get_shooting_mode(self):
        ...
        assert shooting_mode[0]["screenSize"], "Нет ответа от запроса"
    ...
    @pytest.mark.test_case("https://jira.steor.tech/browse/VEGA2-377")
    ...
    def test_get_shooting(self):
        shooting = ApiGatewayAdapter().query("shooting")
        assert shooting[0]["items"], "Нет ответа от запроса"
